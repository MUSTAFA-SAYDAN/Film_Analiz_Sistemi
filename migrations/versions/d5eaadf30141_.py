...
Revision ID: d5eaadf30141
Revises: 
Create Date: 2025-08-09 12:13:08.064764
...
def upgrade():
    ...
    op.create_table('filmler',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('isim', sa.String(length=100), nullable=False),
    sa.Column('yonetmen', sa.String(length=100), nullable=False),
